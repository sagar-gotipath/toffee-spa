  ...
  return (
    <>
      ...
      >
        ...
        <CenterWrapper>
          <nav className="relative hidden w-full space-x-10 text-sm h-14 lg:flex lg:items-center lg:justify-between lg:flex-row ">
            {/* logo */}
            <div className="">
              <Logo src="/assets/images/logo.svg" alt="gotiPath logo" />
            </div>
            {/*  Main Nav  */}
            <div className="">
        ...
        <nav className="relative max-h-screen px-4 lg:hidden">
          <div className="flex items-center justify-between px-0 py-1.5 min-h-14">
            <div className="flex items-center h-full">
              <Logo src="/assets/images/logo.svg" alt="website logo" />
            </div>
            <div className="">
              <span
                ref={navToggler}
