            ...
            return (
              <Disclosure key={index} as="div" className="flex flex-col">
                {({ open }) => (
                  <>
                    <Disclosure.Button>
                      <div className="flex items-center justify-between p-4 mb-1 space-x-3 border-l-2 border-pink-500 cursor-pointer bg-pink-50">
                        <div className="flex items-center space-x-3">
                          <img src="/assets/images/q-icon.png" alt="question icon" className="w-auto h-4" />
                    ...
                    >
                      <Disclosure.Panel as="div" className="flex items-start p-5 space-x-3">
                        <img src="/assets/images/answer-icon.png" alt="answer icon" className="w-auto h-3.5 mt-1.5" />
